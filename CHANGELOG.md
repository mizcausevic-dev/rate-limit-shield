...
### Released
- Shipped **rate-limit-shield** as a public artifact for teams dealing with platform governance.
...
### Shipped
- Cut the first coherent internal version of **rate-limit-shield** with stable domain objects, review surfaces, and decision outputs.
- Established the first reviewable version of the architecture described as: Production-grade rate limiting, circuit breaking, and retry shaping for LLM APIs. Token bucket + breaker + jittered backoff with HTTP 429 / Retry-After awareness.
