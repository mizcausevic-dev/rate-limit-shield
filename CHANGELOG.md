...
### Released
- Published **rate-limit-shield** as a public, portfolio-grade platform governance system.
...
### Shipped
- Cut the first coherent internal version of the product shape behind **rate-limit-shield**.
...
- That insight became the basis for **rate-limit-shield**.
